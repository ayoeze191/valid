  ...
  return (
    <div className="pl-10 pr-2 md:px-20 flex justify-between py-2  box-shadow-header w-full h-fit header">
      ...
      <div className=" flex justify-between items-center gap-5 md:gap-16 ">
        ...
        <NavLink to="/nodes" className="h-fit">  <li className=" ">Nodes</li></NavLink>

         <NavLink to="/calculator" ><li className=" shrink-1 ">Calculator</li></NavLink>

          <li className="flex shrink-1 cursor-pointer">whitespace</li>
        </ul>
         <div style={{"fontFamily": "inter-Bold"}}><span className="ml-2 text-gray-500 " style={{"fontFamily": "inter-Regular"}}>$0.0001</span></div>
        <button className="btn px-5 shrink-1 text-xs md:text-base" style={{"fontFamily": "inter-Bold"}}>Buy VLD</button>
