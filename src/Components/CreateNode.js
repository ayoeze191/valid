  ...
  return (
    <div className=' flex flex-col justify-between gap-10 text-blue-600 font-poppins rounded-lg absolute items-center z-50 bg-white px-4 py-3'>
        ...
        <div className='flex flex-col w-full gap-1'>
           <h3 className='text-sm'> Node Name:</h3> <input type='text' className='border py-1' name = 'name' onChange={(e) => onChangleHandler(e)} />
        </div>
        <div className='flex flex-col gap-1'>
           <h3 className='text-sm'> Amount of Node in VLD:</h3><input type='text' className='border py-1' name = 'amount'onChange={(e) => onChangleHandler(e)}/>
        </div>
